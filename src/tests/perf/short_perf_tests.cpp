...
int64_t raw_avx_add(const std::vector<short>& aV, const std::vector<short> &bV, std::vector<short> &cV, bool print){   
    __START_TIME

    uint64_t pos = 0;
    short cLit = bV[bV.size() / 2];
    __m256i a, b, c;
...
int64_t raw_avx_sub(const std::vector<short>& aV, const std::vector<short> &bV, std::vector<short> &cV, bool print){   
    __START_TIME
